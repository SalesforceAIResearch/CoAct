...
import time
import os
from coact.operator_agent import OrchestratorAgent, OrchestratorUserProxyAgent
from coact.autogen import LLMConfig
import logging
...
def config() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--test_all_meta_path", type=str, default="evaluation_examples/test_1.json"
    )
    parser.add_argument(
...
I will not provide further information to you.""" + "<img data:image/png;base64," + base64.b64encode(screenshot).decode("utf-8") + ">",
            ...
            if cua_steps + coding_steps > cut_off_steps:
                ...
                score, reasoning = orchestrator_proxy.env.evaluate()
